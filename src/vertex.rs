...
// Implement vertex so Vulkano knows how to read our struct as we create the buffers
// Add each of your struct param separately to this macro
vulkano::impl_vertex!(TexturedVertex, position, tex_coords, color);

/// Textured quad with vertices and indices
